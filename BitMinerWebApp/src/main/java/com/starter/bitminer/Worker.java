...
public class Worker implements Runnable {
	...
	String get_random_bytes() {
		String result = restTemplate.getForObject("http://localhost:8080/rng/{howmany}", String.class, "21");
		return result;

	}

	String hash_bytes(String random_bytes) {
		String result = restTemplate.getForObject("http://localhost:8080/hasher/{data}", String.class, random_bytes);
		return result;
